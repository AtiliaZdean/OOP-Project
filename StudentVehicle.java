...
public class StudentVehicle extends JFrame {
	...
	public StudentVehicle() {
		...
		panel_3.setBounds(10, 11, 449, 314);
		ListPage.add(panel_3);
		...
		backButton_1.setFont(new Font("Tahoma", Font.PLAIN, 16));
		backButton_1.setBounds(10, 352, 204, 34);
		ListPage.add(backButton_1);
		
		JButton newRegButton = new JButton("Register");
		newRegButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				tabbedPane.setSelectedIndex(1);
			}
		});
		newRegButton.setFont(new Font("Tahoma", Font.PLAIN, 16));
		newRegButton.setBounds(255, 352, 204, 34);
		ListPage.add(newRegButton);
